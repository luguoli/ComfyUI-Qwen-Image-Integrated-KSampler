...
这是一个集成化的ComfyUI Qwen-Image 生图的采样器节点，相比使用官方的K采样器，告别原版乱七八糟的连线，同时支持文生图和图生图生成，解决了官方节点生图偏移的问题，并且集成了提示词输入框、图片自动缩放、显存/内存自动自动清理、批量生图、自动保存等全面优化功能，妈妈再也不用担心我连线乱七八糟了~~~~
